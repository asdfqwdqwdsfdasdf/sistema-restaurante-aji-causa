  ...
  <div class="flex h-screen">
    ...
    <aside class="w-64 bg-white shadow-md flex flex-col">
      ...
      <nav class="mt-4 flex flex-col gap-2">
        <a href="#" class="px-6 py-2 text-blue-600 bg-blue-100 rounded-r-full font-medium">Dashboard</a>
    ...
    <main class="flex-1 flex flex-col overflow-auto p-6">
      ...
      <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
          ...
          <a href="index.php" class="mt-4 inline-block text-blue-600 hover:text-blue-800">Ver Órdenes</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
          ...
          <a href="registrar_orden.php" class="mt-4 inline-block text-blue-600 hover:text-blue-800">Registrar Nueva Orden</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition">
          ...
          <a href="admin_platos.php" class="mt-4 inline-block text-blue-600 hover:text-blue-800">Ver Platos</a>
        </div>
      </div>
    </main>
  </div>
